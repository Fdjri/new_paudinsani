...
export default async function DataGuruOperatorPage({
  searchParams,
}: {
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-2xl font-bold font-heading text-gray-900">Data Pegawai (Operator)</h1>
          <p className="text-gray-500 text-sm mt-1">Kelola dan perbarui data staf PAUD Insani.</p>
        </div>
      </div>
