...
export const metadata = {
  title: 'SPP (Kepsek) - PAUD Insani',
}

export default async function SppKepsekPage() {
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">Pantau dan kelola pembayaran uang SPP bulanan siswa.</p>
        </div>
      </div>

      <SppMonthGrid basePath="/kepala_sekolah/spp" initialYear={currentYear} />
    </div>
  )
}
